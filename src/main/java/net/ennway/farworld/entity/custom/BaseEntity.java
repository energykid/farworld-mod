...
// this is a class to copy-paste when new entities are added

public class BaseEntity extends Monster {
    ...
    public BaseEntity(EntityType<? extends Monster> entityType, Level level) {
