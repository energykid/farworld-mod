...
public abstract class BystoneTamableMonsterEntity extends Monster implements OwnableEntity {
    ...
    protected BystoneTamableMonsterEntity(EntityType<? extends BystoneTamableMonsterEntity> entityType, Level level) {
    ...
    static {
        DATA_FLAGS_ID = SynchedEntityData.defineId(BystoneTamableMonsterEntity.class, EntityDataSerializers.BYTE);
        DATA_OWNERUUID_ID = SynchedEntityData.defineId(BystoneTamableMonsterEntity.class, EntityDataSerializers.OPTIONAL_UUID);
    }

    public class BystoneTamableMonsterEntityPanicGoal extends PanicGoal {
        public BystoneTamableMonsterEntityPanicGoal(double speedModifier, TagKey<DamageType> panicCausingDamageTypes) {
            super(BystoneTamableMonsterEntity.this, speedModifier, panicCausingDamageTypes);
        }

        public BystoneTamableMonsterEntityPanicGoal(double speedModifier) {
            super(BystoneTamableMonsterEntity.this, speedModifier);
        }

        public void tick() {
            if (!BystoneTamableMonsterEntity.this.unableToMoveToOwner() && BystoneTamableMonsterEntity.this.shouldTryTeleportToOwner()) {
                BystoneTamableMonsterEntity.this.tryToTeleportToOwner();
            }
