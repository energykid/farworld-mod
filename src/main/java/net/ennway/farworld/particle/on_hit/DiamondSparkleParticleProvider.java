...
public class DiamondSparkleParticleProvider implements ParticleProvider<SimpleParticleType> {

    private final SpriteSet spriteSet;

    public DiamondSparkleParticleProvider(SpriteSet spriteSet) {
    ...
    public @Nullable Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level, double x, double y, double z, double xsp, double ysp, double zsp) {
        return new DiamondSparkleParticle(level, x, y, z, spriteSet);
    }
}