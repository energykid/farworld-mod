...
public class ParalysisParticleProvider implements ParticleProvider<SimpleParticleType> {

    private final SpriteSet spriteSet;

    public ParalysisParticleProvider(SpriteSet spriteSet) {
    ...
    public @Nullable Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level, double x, double y, double z, double xsp, double ysp, double zsp) {
        return new ParalysisParticle(level, x, y, z, spriteSet);
    }
}