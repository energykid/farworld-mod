...
public class RedstoneTeleportUpParticle extends StraightUpParticle {

    float rollSpeed = 0f;

    public RedstoneTeleportUpParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>
    {
        ...
        public @Nullable Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level, double x, double y, double z, double xsp, double ysp, double zsp) {
            return new RedstoneTeleportUpParticle(level, x, y, z, spriteSet);
        }
    }
}
