...
public class SurfacedStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final MapCodec<SurfacedStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(SurfacedStructures.settingsCodec(instance),
            ...
            ).apply(instance, SurfacedStructures::new));
    ...
    public SurfacedStructures(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!SurfacedStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.SURFACE_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}